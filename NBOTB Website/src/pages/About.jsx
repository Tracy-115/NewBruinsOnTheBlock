  ...
  Meet the team behind New Bruins On The Block.
      ...
      <div className="team">
        ...
        <div className="team-member-card-background">
          ...
          <p className="team-member-bio">Hello! My name is Christian, and I’m transferring from Saddleback College in Mission Viejo. I’m studying mechanical engineering, and I’m interested in aerospace and robotics. During my free time, I enjoy working out, building projects, listening to music, and eating all-you-can-eat Korean barbecue.</p>
        </div>
        <div className="team-member-card-background">
          <img className="team-member-image" src={SuhanaPic} alt="Suhana" />
          <h3 className="team-member-name">Suhana Suman</h3>
          <p className="team-member-bio">Hi, my name is Suhana and I am a Material Science Engineering major transferring from San Diego Miramar College. Some of my favorite hobbies are art, especially acrylic painting, photography, and designing.</p>
        </div>
        <div className="team-member-card-background">
          <img className="team-member-image" src={TracyPic} alt="Tracy" />
          <h3 className="team-member-name">Kyawt Thinzar (Tracy) Min</h3>
          <p className="team-member-bio">My name is Kyawt Thinzar (Tracy) Min. I am going to transfer to UCLA in Fall 2026 from Diablo Valley College. I am majoring in Electrical Engineering and my end goal is to work to implement renewable energy in creating digital devices. During my free time, I like to cook and visit different neighboring cities.
          </p>
        </div>
      </div>
    </div>
